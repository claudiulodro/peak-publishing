...
if ( ! function_exists( 'peak_publishing_setup' ) ) :
	...
	function peak_publishing_setup() {
		 ...
		 * If you're building a theme based on Peak Publishing, use a find and replace
		 * to change 'peak-publishing' to the name of your theme in all the template files.
		 */
		...
		add_theme_support( 'custom-background', apply_filters( 'peak_publishing_custom_background_args', array(
...
function peak_publishing_scripts() {
	...
	wp_enqueue_script( 'peak-publishing-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
